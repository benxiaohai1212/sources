...
public class HttpClientUtil {
     ...
     * @param httpUrl 地址
     */
    public static String sendHttpPost(final String httpUrl, Map<String, String> maps) throws IOException {
        HttpClient httpclient = new DefaultHttpClient();
        try {
            HttpPost httppost = new HttpPost(httpUrl);
            List<NameValuePair> nvps = new ArrayList<NameValuePair>();
            for (String key : maps.keySet()) {
                nvps.add(new BasicNameValuePair(key, maps.get(key)));
            }
            ...
            ResponseHandler<String> responseHandler = new ResponseHandler<String>() {
                public String handleResponse(HttpResponse response) throws IOException {
                    ...
                    if (statusLine.getStatusCode() >= 300) {
                        throw new HttpResponseException(statusLine.getStatusCode(), "URL = " + httpUrl + " Reason: " + statusLine.getReasonPhrase());
                    }
...
public class HttpClientUtil {
	 ...
	 * @param fileLists 附件
	 */
	public String sendHttpPostFiles(String httpUrl, Map<String, String> maps, List<File> fileLists){
		HttpPost httpPost = new HttpPost(httpUrl);//创建httpPost
     ...
     * @param  附件
     */
    public String sendHttpPostFile(String httpUrl, Map<String, String> maps, File file){
        HttpPost httpPost = new HttpPost(httpUrl);//创建httpPost
        MultipartEntityBuilder meBuilder = MultipartEntityBuilder.create();
...
public class HttpClientTest {
    ...
    public static void main(String args[]) throws UnsupportedEncodingException {
        ...
        String res = HttpClientUtil.getInstance((int)file.length()/1000).
                sendHttpPostFile("http://xxx.xxx.xxx.xxx:xx/upload_file_by_file.json",map,file);
