...
public class Des {  
     ...
     */
    protected static List getKeyBytes(String key) {
     ...
     */
    protected static int[] strToBt(String str) {
        int leng = str.length();  
        int[] bt = new int[64];  
        if (leng < 4) {  
            int i = 0, j = 0, p = 0, q = 0;  
     ...
     * return hex 
     */
    protected static String bt4ToHex(String binary) {
        String hex = "";  
     ...
     */
    protected static String hexToBt4(String hex) {
        String binary = "";  
     ...
     * return string 
     */
    protected static String byteToString(int[] byteData) {
        String str = "";  
        for (int i = 0; i < 4; i++) {  
            int count = 0;  
            for (int j = 0; j < 16; j++) {  
    ...
    protected static String bt64ToHex(int[] byteData) {
        String hex = "";  
        for (int i = 0; i < 16; i++) {  
            String bt = "";  
            for (int j = 0; j < 4; j++) {  
    ...
    protected static String hexToBt64(String hex) {
        String binary = "";  
        for (int i = 0; i < 16; i++) {  
    ...
    protected static int[] enc(int[] dataByte, int[] keyByte) {
    ...
    protected static int[] dec(int[] dataByte, int[] keyByte) {
        int[][] keys = generateKeys(keyByte);  
        int[] ipByte = initPermute(dataByte);  
        int[] ipLeft = new int[32];  
        int[] ipRight = new int[32];  
    ...
    protected static int[] initPermute(int[] originalData) {
    ...
    protected static int[] expandPermute(int[] rightData) {
    ...
    protected static int[] xor(int[] byteOne, int[] byteTwo) {
    ...
    protected static int[] sBoxPermute(int[] expandByte) {
    ...
    protected static int[] pPermute(int[] sBoxByte) {
    ...
    protected static int[] finallyPermute(int[] endByte) {
    ...
    protected static String getBoxBinary(int i) {
        String binary = "";  
        switch (i) {  
        case 0:  
            binary = "0000";  
     ...
     */
    protected static int[][] generateKeys(int[] keyByte) {
        int[] key = new int[56];  
    ...
    public static void main(String[] args) throws Exception {
        ...
        String a = Des.strEnc("Qwer1011!","www.ecloud.com.cn",null,null);
        System.out.println(a);
        String b = desObj.strDec(a,"www.ecloud.com.cn",null,null);
        System.out.println(b);
        System.out.println("============================");
        Long d1 = new Date().getTime();
        System.out.println(StringHelper.longToString(d1,"yyyy-MM-dd HH:mm:ss"));
        String m = Des.strEnc(d1 + "","www.ecloud.com.cn","reset","time");
        System.out.println(d1 + " 转 " + m);
        String d2 = Des.strDec(m,"www.ecloud.com.cn","reset","time");
        System.out.println(m + " 转 " + d2);
        System.out.println(StringHelper.longToString(Long.parseLong(d2),"yyyy-MM-dd HH:mm:ss"));
    }  
}  
```